...
{
    public class WeeklyTimecardReportService
    {
        private readonly TimeCardRepository _timeCardRepository;

        public WeeklyTimecardReportService()
        {
            _timeCardRepository = new TimeCardRepository();
        }

        public WeeklyTimecardReportService(TimeCardRepository timeCardRepo)
        {
            _timeCardRepository = timeCardRepo;
        }
