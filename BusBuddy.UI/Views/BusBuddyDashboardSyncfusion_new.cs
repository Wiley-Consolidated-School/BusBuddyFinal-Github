...
namespace BusBuddy.UI.Views
{
    ...
    /// </summary>
    public partial class BusBuddyDashboardSyncfusion : Form
    {
        ...
        /// <summary>
        /// REFACTORING: Dynamic form discovery with performance caching
        /// </summary>
                        ...
                        if (_formTypeCache.Count == 0)
                        {
                            ...
                            var types = assembly.GetTypes()
                                .Where(type => type.Name.EndsWith("Syncfusion") &&
                                              ...
                                              !type.IsAbstract &&
                                              type != typeof(BusBuddyDashboardSyncfusion)) // Exclude self
                                .ToList();
