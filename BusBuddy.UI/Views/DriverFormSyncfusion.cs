...
namespace BusBuddy.UI.Views
{
    public partial class DriverFormSyncfusion : SyncfusionBaseForm
    {
        ...
        private void CreateControls()
        {
            ...
            _firstNameTextBox = new TextBoxExt { Location = new Point(20, 50), Size = new Size(250, 25) };
            _lastNameTextBox = new TextBoxExt { Location = new Point(300, 50), Size = new Size(250, 25) };
            _licenseTypeComboBox = new ComboBoxAdv { Location = new Point(20, 120), Size = new Size(250, 25) };
            _licenseTypeComboBox.Items.AddRange(new[] { "CDL", "Passenger", "Regular" });
            _cdlExpiryDatePicker = new SfDateTimeEdit { Location = new Point(300, 120), Size = new Size(250, 25), Value = DateTime.Now.AddYears(1) };
            _phoneTextBox = new TextBoxExt { Location = new Point(20, 190), Size = new Size(250, 25) };
            _emailTextBox = new TextBoxExt { Location = new Point(300, 190), Size = new Size(250, 25) };
            _statusComboBox = new ComboBoxAdv { Location = new Point(20, 260), Size = new Size(250, 25) };
