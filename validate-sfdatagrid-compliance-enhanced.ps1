...
Write-Host ""
Write-Host "📊 Detailed results saved to: compliance-results-enhanced.json" -ForegroundColor Cyan

# Save detailed results to JSON
$complianceResults | ConvertTo-Json -Depth 4 | Out-File "compliance-results-enhanced.json" -Encoding UTF8
