...
{
    /// <summary>
    /// Tests for DriverRepository ensuring proper CRUD operations and data integrity.
    ...
    public class DriverRepositoryTest : IDisposable
    {
        ...
        [Fact]
        public void GetAllDrivers_ShouldReturnListOfDrivers()
        {
            // Act
        ...
        [Fact]
        public void AddDriver_WithValidData_ShouldReturnDriverId()
        {
            // Arrange
        ...
        [Fact]
        public void GetDriverById_WithValidId_ShouldReturnDriver()
        {
            // Arrange
            var driver = new Driver
            {
